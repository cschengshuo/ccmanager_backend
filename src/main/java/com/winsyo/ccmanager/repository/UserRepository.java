...
public interface UserRepository extends JpaRepository<User, String>, JpaSpecificationExecutor<User> {
  ...
  void updateUserInfo(@Param(value = "name") String name, @Param(value = "phone") String phone, @Param(value = "IDNumber") String IDNumber, @Param(value = "username") String username);
